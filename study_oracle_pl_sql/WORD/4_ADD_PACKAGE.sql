...
CREATE OR REPLACE PACKAGE PACKAGE_WORDS_WORDS IS
  ...
  PROCEDURE UPDATE_WORD(PART_OF_SPEECH_IN IN T_WORDS.PART_OF_SPEECH%TYPE,
                                  PART_OF_SPEECH_ID_IN IN T_WORDS.PART_OF_SPEECH_ID%TYPE);
  PROCEDURE DELETE_WORD(PART_OF_SPEECH_IN IN T_WORDS.PART_OF_SPEECH%TYPE,
                                  PART_OF_SPEECH_ID_IN IN T_WORDS.PART_OF_SPEECH_ID%TYPE,
                                  DELETE_AUDIT_TABLE_IN IN INTEGER DEFAULT 1);
  PROCEDURE SELECT_WORD_BY_ID(PART_OF_SPEECH_ID_IN IN T_WORDS.PART_OF_SPEECH_ID%TYPE,
                                        PART_OF_SPEECH_OUT OUT T_WORDS.PART_OF_SPEECH%TYPE);
  PROCEDURE SELECT_WORD_BY_WORD(PART_OF_SPEECH_IN IN T_WORDS.PART_OF_SPEECH%TYPE,
                                          PART_OF_SPEECH_ID_OUT OUT T_WORDS.PART_OF_SPEECH_ID%TYPE);
