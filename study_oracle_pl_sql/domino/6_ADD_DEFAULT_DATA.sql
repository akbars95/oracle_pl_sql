...
BEGIN
  --DELETE
  PKG_DOMINOS_GAME_USER_DOMINOS.DELETE_ALL_GAME_USER_DOMINOS;
...
--    DBMS_OUTPUT.PUT_LINE('USER - ' || PKG_DOMINOS_GAMES_ATTENDEES.GET_G_A_BY_G_NAME_AND_U_NAME(PKG_DOMINOS_GAMES.GET_GAME_BY_GAME_NAME(L_GAME_NAME), PKG_DOMINOS_USERS.GET_USER_BY_USER_EMAIL(L_USER1_IVANOV)));
  FOR I IN 1 .. 7
  LOOP
  ...
  LOOP
    PKG_DOMINOS_GAME_USER_DOMINOS.INSERT_GAME_USER_DOMINOS(GAME_ATTENDEE_ID_IN => 
          PKG_DOMINOS_GAMES_ATTENDEES.GET_G_A_BY_G_NAME_AND_U_NAME(PKG_DOMINOS_GAMES.GET_GAME_BY_GAME_NAME(L_GAME_NAME), PKG_DOMINOS_USERS.GET_USER_BY_USER_EMAIL(L_USER4_VASILIEV)));
  END LOOP;
  ...
  LOOP
    PKG_DOMINOS_GAME_USER_DOMINOS.INSERT_GAME_USER_DOMINOS(GAME_ATTENDEE_ID_IN => 
          PKG_DOMINOS_GAMES_ATTENDEES.GET_G_A_BY_G_NAME_AND_U_NAME(PKG_DOMINOS_GAMES.GET_GAME_BY_GAME_NAME(L_GAME_NAME), PKG_DOMINOS_USERS.GET_USER_BY_USER_EMAIL(L_USER1_IVANOV)));
  END LOOP;*/
    /*PKG_DOMINOS_GAME_USER_DOMINOS.INSERT_GAME_USER_DOMINOS(
    PKG_DOMINOS_GAMES_ATTENDEES.GET_G_A_BY_G_NAME_AND_U_NAME(PKG_DOMINOS_GAMES.GET_GAME_BY_GAME_NAME(L_GAME_NAME), PKG_DOMINOS_USERS.GET_USER_BY_USER_EMAIL(L_USER1_IVANOV)),
    PKG_DOMINOS_DOMINOS.GET_RANDOM_DOMINO_ID);
